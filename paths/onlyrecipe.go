	...
	return (
		func(ctx *fiber.Ctx) error {
			...
			query := fmt.Sprintf(
				...
				corn_starch = %t, soy_sauce = %t, cookingWine = %t, ginger = %t, scallion = %t, vinegar = %t, cabbage = %t, mushroom = %t, chickenPowder = %t, yeast = %t, tomato_sauce = %t, tomato_paste = %t, tomato = %t, basil = %t, oregano = %t, garlic = %t, onion_powder = %t, pepperoni = %t, cheese = %t, pepperPowder = %t`,
